...
(function() {
    ...
    M.t0 = function t0(m, c0, i0, l0, a0) {
        ...
        r0 += "</a>";
        r0 += "<h2 class=\"" + "sub-header anchor" + "\" data-hash=\"" + "examples/link" + "\">";
        r0 += "Link";
        r0 += "</h2>";
        r0 += "To display link, use the tag ";
        r0 += "<code>";
        r0 += "&lt;xb-link&gt;";
        r0 += "</code>";
        r0 += ".";
        ...
        r0 += "Button checkbox:";
        r0 += "<div class=\"" + "bs-docs-example is-code" + "\">";
        r0 += "<xb-button type=\"" + "checkbox" + "\" name=\"" + "bt1" + "\" value=\"" + "1" + "\">" + "checkbox 1" + "</xb-button>";
        r0 += " ";
        r0 += "<xb-button type=\"" + "checkbox" + "\" name=\"" + "bt2" + "\" value=\"" + "2" + "\">" + "checkbox 2" + "</xb-button>";
        r0 += "</div>";
        r0 += "<div class=\"" + "highlight" + "\">";
        r0 += "<pre>";
        r0 += "<code class=\"" + "html" + "\">";
        ...
        r0 += "Button radio:";
        r0 += "<div class=\"" + "bs-docs-example is-code" + "\">";
        r0 += "<xb-button type=\"" + "radio" + "\" name=\"" + "bt3" + "\" value=\"" + "1" + "\">" + "radio 1" + "</xb-button>";
        r0 += " ";
        r0 += "<xb-button type=\"" + "radio" + "\" name=\"" + "bt3" + "\" value=\"" + "2" + "\">" + "radio 2" + "</xb-button>";
        r0 += "</div>";
        r0 += "<div class=\"" + "highlight" + "\">";
        r0 += "<pre>";
        r0 += "<code class=\"" + "html" + "\">";
        ...
        r0 += "</a>";
        r0 += "<h2 class=\"" + "sub-header anchor" + "\" data-hash=\"" + "examples/checkbox" + "\">";
        r0 += "Checkbox";
        r0 += "</h2>";
        r0 += "To display checkbox, use the tag ";
        r0 += "<code>";
        r0 += "&lt;xb-checkbox&gt;";
        r0 += "</code>";
        r0 += ".";
        r0 += "<h2 class=\"" + "sub-header anchor" + "\" data-hash=\"" + "examples/radio" + "\">";
        r0 += "Radio";
        r0 += "</h2>";
        r0 += "To display radio, use the tag ";
        r0 += "<code>";
        r0 += "&lt;xb-radio&gt;";
        r0 += "</code>";
        r0 += ".";
        r0 += "<h2 class=\"" + "sub-header anchor" + "\" data-hash=\"" + "examples/input" + "\">";
        r0 += "Input";
        r0 += "</h2>";
        r0 += "To display input, use the tag ";
        r0 += "<code>";
        r0 += "&lt;xb-input&gt;";
        r0 += "</code>";
        r0 += ".";
        r0 += "<h2 class=\"" + "sub-header anchor" + "\" data-hash=\"" + "examples/popup" + "\">";
        r0 += "Popup";
        r0 += "</h2>";
        r0 += "To display popup, use the tag ";
        r0 += "<code>";
        r0 += "&lt;xb-popup&gt;";
        r0 += "</code>";
        r0 += ".";
        r0 += "<h2 class=\"" + "sub-header anchor" + "\" data-hash=\"" + "examples/menu" + "\">";
        r0 += "Menu";
        r0 += "</h2>";
        r0 += "To display menu, use the tag ";
        r0 += "<code>";
        r0 += "&lt;xb-menu&gt;";
        r0 += "</code>";
        r0 += ".";
