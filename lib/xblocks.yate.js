...
(function() {
    ...
    var j9 = [ 0, 'attrs', 0, 'label-href' ];

    var j10 = [ 0, 'attrs', 0, 'label-target' ];

    var j11 = [ 0, 'attrs', 0, 'multiline' ];

    var j12 = [ 0, 'attrs', 0, 'value' ];
    ...
    M.t2 = function t2(m, c0, i0, l0, a0) {
        ...
        if (nodeset2boolean( (m.s(j7, c0)) )) {
            ...
            if (nodeset2boolean( (m.s(j9, c0)) )) {
                a0.a[ "href" ] = new yr.scalarAttr(nodeset2scalar( ( m.s(j9, c0) ) ));
            }
            if (nodeset2boolean( (m.s(j10, c0)) )) {
                a0.a[ "target" ] = new yr.scalarAttr(nodeset2scalar( ( m.s(j10, c0) ) ));
            }
            r0 += closeAttrs(a0);
