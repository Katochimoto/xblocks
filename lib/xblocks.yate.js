...
(function() {
    ...
    var j7 = [ 0, 'attrs', 0, 'xb-size' ];

    var j8 = [ 0, 'attrs', 0, 'xb-theme' ];

    var j9 = [ 0, 'attrs', 0, 'disabled' ];
    ...
    var j14 = [ 0, 'attrs', 0, 'name' ];

    var j15 = [ 0, 'attrs', 0, 'multiple' ];
    ...
    M.t4 = function t4(m, c0, i0, l0, a0) {
        ...
        r0 += m.a(m, m.s(j1, c0), 'style', a0)
        r0 += closeAttrs(a0);
        r0 += "<button";
        a0.a = {
            'class': new yr.scalarAttr("nb-button nb-button_size_" + nodeset2scalar( ( m.s(j7, c0) ) ) + " nb-button_theme_" + nodeset2scalar( ( m.s(j8, c0) ) ))
        };
        a0.s = 'button';
        r0 += m.a(m, m.s(j4, c0), 'xb-core-attrs', a0)
    ...
    M.t6 = function t6(m, c0, i0, l0, a0) {
        ...
        r0 += "<label";
        a0.a = {
            'class': new yr.scalarAttr("nb-button nb-button_size_" + nodeset2scalar( ( m.s(j7, c0) ) ) + " nb-button_type_attach nb-button_theme_" + nodeset2scalar( ( m.s(j8, c0) ) ))
        };
        a0.s = 'label';
        r0 += m.a(m, m.s(j4, c0), 'xb-core-attrs', a0)
        if (nodeset2boolean( (m.s(j9, c0)) )) {
        ...
        if (nodeset2boolean( (m.s(j14, c0)) )) {
            a0.a[ "name" ] = new yr.scalarAttr(nodeset2scalar( ( m.s(j14, c0) ) ));
        }
