...
(function() {
    ...
    M.t0 = function t0(m, c0, i0, l0, a0, v0, v1) {
        ...
        if ((c0.name == "xb-size")) {
            var tmp0 = a0.a[ "class" ];
            if (tmp0) {
                a0.a[ "class" ] = tmp0.addscalar(" nb-input_size_" + nodeset2scalar( ( m.s(j1, c0) ) ));
            } else {
                a0.a[ "class" ] = new yr.scalarAttr(" nb-input_size_" + nodeset2scalar( ( m.s(j1, c0) ) ));
            }
        }
    ...
    M.t3 = function t3(m, c0, i0, l0, a0) {
        ...
        if ((nodeset2boolean( m.s(j10, c0) ) || nodeset2boolean( m.s(j11, c0) ))) {
            r0 += "<textarea";
            a0.a = {
                'class': new yr.scalarAttr("nb-input nb-input_type_simple")
            };
            a0.s = 'textarea';
            r0 += m.a(m, m.s(j3, c0), 'attrs', a0)
            r0 += closeAttrs(a0);
...
(function() {
    ...
    M.t0 = function t0(m, c0, i0, l0, a0) {
        ...
        r0 += m.a(m, m.s(j1, c0), 'xb-core-attrs', a0, v0, true)
        if ((c0.name == "disabled" && nodeset2boolean( m.s(j1, c0) ))) {
            var tmp0 = a0.a[ "class" ];
            if (tmp0) {
    ...
    M.t4 = function t4(m, c0, i0, l0, a0) {
        ...
        a0.s = 'input';
        r0 += m.a(m, m.s(j1, c0), 'xb-core-attrs', a0, v1)
        r0 += closeAttrs(a0);
        r0 += '';
