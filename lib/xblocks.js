...
/* lib/xblocks/types/number.js begin */
(function(xtag, xblocks) {
    xblocks = xblocks || {};
...
/* lib/xblocks/types/number.js end */


borschik.addLinks(/* ../lib/freeze.json begin */
{"button.css":"/lib/_/AZnriBj1ZZBQrUhlEHFHAIXPLOk.css","field.css":"/lib/_/P5a03DDDFz-DcRnxHXpsh56w5qI.css"}
/* ../lib/freeze.json end */
);
...
(function(xtag, xblocks) {
    ...
    (function(schema) {
        ...
        /* blocks/button/schema.json begin */
{
    "type":"object",
        ...
        "attrs": {
            ...
            "properties":{
                ...
                "ico": {
                    ...
                    "id": "http://xblocks.ru/xb-button/attrs/ico",
                    "required":false
                },
                "size": {
                    "id": "http://xblocks.ru/xb-button/attrs/size",
                    "required":false,
                    "enum": ["s", "m", "l"]
                },
                "theme": {
                    "id": "http://xblocks.ru/xb-button/attrs/theme",
                    "required":false,
...
(function(xtag, xblocks) {
    ...
    (function(schema) {
        ...
        /* blocks/field/schema.json begin */
{
    "type":"object",
    "$schema": "http://json-schema.org/draft-04/schema#",
    "title": "Button",
    ...
    "properties":{
        "attrs": {
            ...
            "properties":{
                ...
                "size": {
                    "id": "http://xblocks.ru/xb-field/attrs/size",
                    "required":false,
                    "enum": ["s", "m", "l"]
                },
                "theme": {
                    "id": "http://xblocks.ru/xb-field/attrs/theme",
                    "required":false,
                    "enum": ["normal", "action", "dark", "pseudo"]
                },
                "rows": {
                ...
                "label": {
                    "id": "http://xblocks.ru/xb-field/attrs/label",
                    "required":false,
                    "type": "string"
                },
                "label-target": {
                    "id": "http://xblocks.ru/xb-field/attrs/label-target",
                    "required":false,
                    "enum": ["_blank", "_parent", "_self", "_top"]
                },
                "label-href": {
                    "id": "http://xblocks.ru/xb-field/attrs/label-href",
                    "required":false,
                    "type": "string"
                },
                "placeholder": {
